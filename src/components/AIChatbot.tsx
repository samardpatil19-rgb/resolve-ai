...
export function FloatingChatButton({ onClick, requiresPremium = false }: { onClick: () => void; requiresPremium?: boolean }) {
    ...
    return (
        <button
            ...
            title={requiresPremium && !isPremium ? "Upgrade to Pro for AI Chat" : "Chat with AI Assistant"}
        >
